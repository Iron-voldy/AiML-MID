...
class QuizApp {
    ...
    updateTimerDisplay() {
        ...
        if (this.timeRemaining <= 300) { // 5 minutes
            this.timerElement.style.color = 'var(--accent-red)';
        } else if (this.timeRemaining <= 600) { // 10 minutes
            this.timerElement.style.color = 'var(--accent-orange)';
        }
    }
    ...
    showResultScreen() {
        ...
        const timeTakenSeconds = this.timeLimit - this.timeRemaining;
